...
class _HomePageState extends State<HomePage> {
  ...
  final TextEditingController totalGuestsController = TextEditingController();
  ...
  // Enhanced onSearch function dari document

  Future<void> _loadName() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      firstName = prefs.getString('user_firstName') ?? 'User';
    });
  }
  ...
  void _showRoomDetail(BuildContext context, Room room) {
    roomIdController.text = room.id!.toString();
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 24),
                              TextField(
                                controller: checkInController, // tambahkan ini
                                readOnly: true,
                                onTap: () async {
                              ...
                              TextField(
                                ...
                                onChanged: (_) => _updateTotalGuests(),
                                style: const TextStyle(color: Colors.white),
                                decoration: InputDecoration(
                              ...
                              const SizedBox(height: 24),
                              TextField(
                                controller: totalGuestsController,
                                keyboardType: TextInputType.number,
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    print('BOOK NOW ditekan');
                                    try {
                                      print('Mempersiapkan data booking...');
                                      print('checkInDate: $checkInDate');
                                      print('checkOutDate: $checkOutDate');
                                      print(
                                        'guestFullName: ${fullNameController.text}',
                                      );
                                      print(
                                        'guestEmail: ${emailController.text}',
                                      );
                                      print(
                                        'numOfAdults: ${adultsController.text}',
                                      );
                                      print(
                                        'numOfChildren: ${childrenController.text}',
                                      );
                                      print(
                                        'totalNumOfGuest: ${totalGuestsController.text}',
                                      );
                                      print(
                                        'bookingConfirmationCode: ${confirmationCodeController.text}',
                                      );
                                      ...
                                      await bookingService.submitBooking(
                                        ...
                                        guestFullName: fullNameController.text,
                                        guestEmail: emailController.text,
                                        numOfAdults: int.parse(
                                          adultsController.text,
                                        ),
                                        numOfChildren: int.parse(
                                          childrenController.text,
                                        ),
                                        totalNumOfGuest: int.parse(
                                          totalGuestsController.text,
                                        ),
                                      ...
                                      print('Booking request berhasil dikirim');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Kondisi: AppBar hanya muncul di Home (index 0)
      appBar:
          _currentIndex == 0
              ? AppBar(
                backgroundColor: Colors.transparent,
              ...
              : null, // Jika bukan Home, AppBar tidak ditampilkan
